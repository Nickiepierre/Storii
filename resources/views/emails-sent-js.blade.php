...
<script>
  $(document).ready(function() {
    datatableEmailsSents.init();
    $("#sendEmails").click(function sendEmails(e) {
		e.preventDefault();
		var b = $(this), f = $("#formModalEmailsSend");
    console.log(f);
  ...
  var datatableEmailsSents = {
  	init: function() {
    	var t;
    	t = $("#datatableEmailsSents").DataTable({
					 	responsive: !1,
					 	//searchDelay: 500,
					 	processing: !0,
					 	serverSide: !0,
